...
export default function Cart() {
  ...
  const [payment, setPayment] = useState('COD'); // Cash On Delivery by default
...
const styles = StyleSheet.create({
  ...
  heading: { fontSize: 28, fontWeight: '700', marginBottom: 16, color: '#333' },
  cartItem: {
    flexDirection: 'row',
  ...
  total: { fontSize: 20, fontWeight: '700', marginVertical: 12, textAlign: 'right' },
  confirmBtn: {
    backgroundColor: '#4CAF50',
    padding: 16,
    borderRadius: 8,
